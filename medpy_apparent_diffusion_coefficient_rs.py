#!C:\Code\ActiveSurveillance\DWItoADC\.venv\Scripts\python.exe
...
# code
def adcCalc(pathb0img: str, pathbximg: str,bval: int,pathopimg: str, thresh = None):
    ...
    b0img, b0hdr = load(pathb0img)
    bximg, bxhdr = load(pathbximg)
    ...
    if thresh is not None and not thresh >= 0:
    ...
    adc[mask] = -1. * bval * numpy.log(bximg[mask] / b0img[mask])
    adc[adc < 0] = 0
            
    # saving the resulting image
    save(adc, pathopimg, b0hdr)
